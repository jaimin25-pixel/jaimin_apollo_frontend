    ...
    <div v-else-if="profile" class="profile-content">
      ...
      <div class="profile-header">
        ...
        <div class="profile-info">
          ...
          <p class="doc-code">{{ profile.doc_code }}</p>
          <p class="specialization">{{ profile.specialization }}</p>
          <p class="status" :class="`status-${profile.status?.toLowerCase()}`">
            {{ profile.status }}
          </p>
        </div>
      </div>
      ...
      <div class="details-grid">
        ...
        <div class="details-column">
          <div class="detail-section">
            ...
            <div class="detail-item">
              <label>Status</label>
              <span :class="`badge badge-${profile.status?.toLowerCase()}`">
                {{ profile.status }}
              </span>
            </div>
          </div>
...
const profile = computed(() => authStore.doctor)
...
const getInitials = computed(() => {
  if (!profile.value?.full_name) return 'D'
