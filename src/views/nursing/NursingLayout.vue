  ...
  <div class="nursing-layout">
    <aside class="sidebar" :class="{ collapsed: sidebarCollapsed }">
      <div class="sidebar-header">
        ...
        <span v-if="!sidebarCollapsed" class="sidebar-title">Apollo Nursing</span>
...
const pageTitle = computed(() => {
  const titles: Record<string, string> = {
    '/nursing/dashboard': 'Dashboard',
    '/nursing/wards': 'Wards & Beds',
    '/nursing/patients': 'Patients List'
  }
  return titles[route.path] || 'Nursing Portal'
})
...
const navItems = [
  ...
  },
  {
    path: '/nursing/wards',
    label: 'Wards & Beds',
    icon: '<svg width="18" height="18" viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="2.25" y="4.5" width="13.5" height="9" rx="1"/><path d="M2.25 10.5h13.5M6.75 4.5v6"/></svg>',
  },
  {
