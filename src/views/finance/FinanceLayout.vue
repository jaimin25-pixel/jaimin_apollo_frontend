  ...
  <div class="finance-layout">
    <aside class="sidebar" :class="{ collapsed: sidebarCollapsed }">
      <div class="sidebar-header">
        ...
        <span v-if="!sidebarCollapsed" class="sidebar-title">Apollo Finance</span>
...
const pageTitle = computed(() => {
  ...
  return titles[route.path] || 'Finance Portal'
})
...
const navItems = [
  ...
  },
  {
    ...
    label: 'Invoices',
    icon: '<svg width="18" height="18" viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M13.5 15.75H4.5a1.5 1.5 0 01-1.5-1.5V3.75a1.5 1.5 0 011.5-1.5h5.69a1.5 1.5 0 011.06.44l3.56 3.56a1.5 1.5 0 01.44 1.06v6.94a1.5 1.5 0 01-1.5 1.5z" /></svg>',
  },
  {
